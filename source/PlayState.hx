...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['get fucked lmao', 0.2], //From 0% to 19%
		['Shit', 0.4], //From 20% to 39%
		['fuck you', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Sex', 0.7], //69%
		['Good', 0.8], //From 70% to 79%
		['Pro Gamin', 0.9], //From 80% to 89%
		['Flippy Level!', 1], //From 90% to 99%
		['Flippy Level Or Hax!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
