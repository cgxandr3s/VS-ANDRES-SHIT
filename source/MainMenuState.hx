...
{
	public static var andresVersion:String = '1.0.0';
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('main img'));
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Andres v" + andresVersion, 12);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://twitter.com/CGXAndres64');
				}
				else
				{
					selectedSomethin = true;
